...
def _get_remote_db_config(context) -> dict:
    # django-environ is installed with inv project.build
    # so we import environ this way because it may not be installed
    ...
    settings = {
        "DB_NAME": env.str("RDS_DB_NAME"),
        "DB_USER": env.str("RDS_DB_USER"),
        "DB_PASSWORD": env.str("RDS_DB_PASSWORD"),
        "DB_HOST": env.str("RDS_DB_HOST"),
        "DB_PORT": env.str("RDS_DB_PORT"),
    }
