...
```bash
pyenv virtualenv-delete --force photo-analytics-backend
pyenv install 3.11 --skip-existing
pyenv virtualenv `pyenv latest 3.11` photo-analytics-backend
pyenv local photo-analytics-backend
pyenv activate photo-analytics-backend
```
